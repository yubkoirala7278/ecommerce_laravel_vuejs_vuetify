      ...
      <v-col cols="12" sm="8" md="5">
        <v-card elevation="10" class="pa-5 rounded-xl">
          <v-card-title class="text-center">
            <h3 class="font-weight-bold text-primary">Register</h3>
          </v-card-title>

          <v-card-text>
            <v-form @submit.prevent="authStore.handleRegister(form)">
              <v-text-field v-model="form.name" label="Full Name" type="text" placeholder="Enter your full name"
                id="name" variant="outlined" class="mb-3 rounded-lg" density="comfortable"
